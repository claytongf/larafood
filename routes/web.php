...
Route::prefix('admin')
    ...
    ->group(function () {
         ...
         */
        Route::get('profiles/{idProfile}/permissions/{idPermission}/detach', 'ACL\PermissionProfileController@detachPermissionsProfile')->name('profiles.permissions.detach');
